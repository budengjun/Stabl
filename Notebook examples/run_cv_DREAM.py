...
sgl_cv = GridSearchCV(
    sgl,
    scoring="roc_auc",
    param_grid={"alpha": np.logspace(-3, 0, 10), "l1_ratio": np.linspace(0.2, 0.8, 3)},
    cv=chosen_inner_cv,
    n_jobs=-1,
)
...
stabl_en = clone(stabl).set_params(
    ...
    n_bootstraps=50,
    lambda_grid=[
        {"C": np.logspace(-3, -2, 5), "l1_ratio": [0.2]},
        {"C": np.logspace(-3, -2, 5), "l1_ratio": [0.5]},
        {"C": np.logspace(-3, -2, 5), "l1_ratio": [0.8]},
    ],
    verbose=1,
)
...
stabl_sgl = clone(stabl).set_params(
    ...
    n_bootstraps=50,
    lambda_grid=[
        {"alpha": np.logspace(-3, -2, 5), "l1_ratio": [0.2]},
        {"alpha": np.logspace(-3, -2, 5), "l1_ratio": [0.5]},
        {"alpha": np.logspace(-3, -2, 5), "l1_ratio": [0.8]},
    ],
    verbose=1,
)
