...
lasso = LogisticRegression(
    penalty="l1", max_iter=int(1e6), random_state=42, solver="liblinear"
)
...
en = LogisticRegression(
    penalty="elasticnet", max_iter=int(1e4), random_state=42, solver="saga"
)
en_params = {"C": np.logspace(-2, 1, 5), "l1_ratio": [0.5, 0.7, 0.9]}
en_cv = GridSearchCV(
...
# ALasso
alasso = ALogitLasso(
    penalty="l1", solver="liblinear", max_iter=int(1e6), random_state=42
)
