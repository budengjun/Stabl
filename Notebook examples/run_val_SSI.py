...
stabl_alasso = clone(stabl).set_params(
    base_estimator=alasso, lambda_grid={"C": np.linspace(0.01, 10, 30)}, verbose=1
)
...
stabl_en = clone(stabl).set_params(
    ...
    n_bootstraps=1000,
    lambda_grid=[
        {"C": np.logspace(-2, 0, 10), "l1_ratio": [0.5]},
        {"C": np.logspace(-2, 0, 10), "l1_ratio": [0.7]},
        {"C": np.logspace(-2, 0, 10), "l1_ratio": [0.9]},
    ],
    verbose=1,
)
...
stabl_sgl = clone(stabl).set_params(
    ...
    lambda_grid=[
        {"alpha": np.logspace(-2, 0, 10), "l1_ratio": [0.5]},
        {"alpha": np.logspace(-2, 0, 10), "l1_ratio": [0.7]},
        {"alpha": np.logspace(-2, 0, 10), "l1_ratio": [0.9]},
    ],
    verbose=1,
)
