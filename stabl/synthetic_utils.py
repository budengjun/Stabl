...
def compute_est_FDR(stability_selection):
    ...
    thresholds_grid = np.arange(0.0, 1.0, 0.01)
...
def save_fdr_figures(true_FDRs_decoy, estimated_FDRs_decoy, path):
    fig, ax = plt.subplots(figsize=(8, 6))
    x = np.arange(0, 1, 0.01)

    plt.plot(
        x, np.median(true_FDRs_decoy, axis=0), label="FDR", linewidth=2, color="#4D4F53"
    )
    plt.fill_between(
        x,
    ...
    plt.plot(
        x,
        np.median(estimated_FDRs_decoy, axis=0),
        label="FDP +",
        linewidth=2,
        color="#C41E3A",
    )
    ...
    plt.axvline(min_FDP, label="min FDP +", lw=2, ls="--", color="#C41E3A")
...
def save_jaccard_decoy_lasso(df_results, path):
    ...
    decoy_stab_low = list(
        df_results["Decoy_Jaccard_Stab_Median"] - df_results["Decoy_Jaccard_Stab_Q1"]
    )
    decoy_stab_up = list(
        -df_results["Decoy_Jaccard_Stab_Median"] + df_results["Decoy_Jaccard_Stab_Q3"]
    )

    # Jaccard performance for decoy
    decoy_perf_low = list(
        df_results["Decoy_Jaccard_Perf_Median"] - df_results["Decoy_Jaccard_Perf_Q1"]
    )
    decoy_perf_up = list(
        -df_results["Decoy_Jaccard_Perf_Median"] + df_results["Decoy_Jaccard_Perf_Q3"]
    )

    # Jaccard stability for lasso
    lasso_stab_low = list(
        df_results["Lasso_Jaccard_Stab_Median"] - df_results["Lasso_Jaccard_Stab_Q1"]
    )
    lasso_stab_up = list(
        -df_results["Lasso_Jaccard_Stab_Median"] + df_results["Lasso_Jaccard_Stab_Q3"]
    )

    # Jaccard performance for lasso
    lasso_perf_low = list(
        df_results["Lasso_Jaccard_Perf_Median"] - df_results["Lasso_Jaccard_Perf_Q1"]
    )
    lasso_perf_up = list(
        -df_results["Lasso_Jaccard_Perf_Median"] + df_results["Lasso_Jaccard_Perf_Q3"]
    )
...
def save_jaccard_decoy_stab(df_results, path):
    ...
    plt.plot(
        df_results.index,
        df_results.SS_03_Jaccard_Stab_Median,
        linestyle=":",
        marker="o",
        color="C1",
        label="Stab 0.3",
    ...
    plt.plot(
        df_results.index,
        df_results.SS_05_Jaccard_Stab_Median,
        linestyle=":",
        marker="o",
        color="C2",
        label="Stab 0.5",
    ...
    plt.plot(
        df_results.index,
        df_results.SS_08_Jaccard_Stab_Median,
        linestyle=":",
        marker="o",
        color="C3",
        label="Stab 0.8",
    ...
    plt.plot(
        df_results.index,
        df_results.SS_03_Jaccard_Perf_Median,
        linestyle=":",
        marker="o",
        color="C1",
        label="Stab 0.3",
    ...
    plt.plot(
        df_results.index,
        df_results.SS_05_Jaccard_Perf_Median,
        linestyle=":",
        marker="o",
        color="C2",
        label="Stab 0.5",
    ...
    plt.plot(
        df_results.index,
        df_results.SS_08_Jaccard_Perf_Median,
        linestyle=":",
        marker="o",
        color="C3",
        label="Stab 0.8",
...
def save_nb_features_plot(df_results, path, nb_info):
    ...
    plt.plot(
        df_results.index,
        df_results.Avg_nb_features_Lasso,
        linestyle=":",
        marker="o",
        label="Lasso",
    )
    plt.plot(
        df_results.index,
        df_results.Avg_nb_features_Decoy,
        linestyle=":",
        marker="o",
        label="Decoy",
    )
    ...
    plt.plot(
        df_results.index,
        df_results.Avg_nb_features_SS_03,
        linestyle=":",
        marker="o",
        label="Stab 0.3",
    )
    plt.plot(
        df_results.index,
        df_results.Avg_nb_features_SS_05,
        linestyle=":",
        marker="o",
        label="Stab 0.5",
    )
    plt.plot(
        df_results.index,
        df_results.Avg_nb_features_SS_08,
        linestyle=":",
        marker="o",
        label="Stab 0.8",
    )
...
def create_results_folder(result_folder_title, nb_features, nb_info):
    os.makedirs(
        f"{result_folder_title}/NbFeatures={nb_features}_NbInfo={nb_info}/FDR graphs",
        exist_ok=True,
    )
    os.makedirs(
        f"{result_folder_title}/NbFeatures={nb_features}_NbInfo={nb_info}/Avg features graphs",
        exist_ok=True,
    )
    os.makedirs(
        f"{result_folder_title}/NbFeatures={nb_features}_NbInfo={nb_info}/Predictions",
        exist_ok=True,
    )
    os.makedirs(
        f"{result_folder_title}/NbFeatures={nb_features}_NbInfo={nb_info}/Scores/MSE",
        exist_ok=True,
    )
    os.makedirs(
        f"{result_folder_title}/NbFeatures={nb_features}_NbInfo={nb_info}/Scores/MAE",
        exist_ok=True,
    )
    os.makedirs(
        f"{result_folder_title}/NbFeatures={nb_features}_NbInfo={nb_info}/Scores/R2",
        exist_ok=True,
    )
    os.makedirs(
        f"{result_folder_title}/NbFeatures={nb_features}_NbInfo={nb_info}/Jaccard",
        exist_ok=True,
    )
...
def synthetic_benchmark_regression(
    ...
    for n_features in n_features_list:
        for n_info in n_informative_list:
            ...
            print(
                f"Computation for {n_features} features with {n_info} informative ones"
            )
            print(
                "======================================================================="
            )
            ...
            X_train, X_test, y_train, y_test = make_train_test(
                n_features=n_features, n_informative=n_info
            )
            ...
            for n_samples in n_samples_list:
                ...
                for iteration in range(n_experiments):
                    if iteration % 10 == 0:
                        print(
                            "Repetition of this experiment %d/%d"
                            % (iteration + 1, n_experiments)
                        )
                    ...
                    l_max = (
                        np.linalg.norm(X_subtrain.T @ y_subtrain, np.inf)
                        / X_subtrain.shape[0]
                    )
                    ...
                    true_FDRs_ss.append(
                        compute_true_FDR(stab_sel, groud_truth_features)
                    )

                    ss_features_03 = list(
                        stab_sel.get_support(indices=True, new_hard_threshold=0.3)
                    )
                    jaccard_ground_truth_ss_03.append(
                        jaccard_similarity(ss_features_03, groud_truth_features)
                    )
                    ...
                    if len(ss_features_03) == 0:
                        ...
                        ss_03_ridge = clone(ridgecv).fit(
                            X_subtrain[:, ss_features_03], y_subtrain
                        )
                    ...
                    ss_features_05 = list(
                        stab_sel.get_support(indices=True, new_hard_threshold=0.5)
                    )
                    jaccard_ground_truth_ss_05.append(
                        jaccard_similarity(ss_features_05, groud_truth_features)
                    )
                    ...
                    if len(ss_features_05) == 0:
                        ...
                        ss_05_ridge = clone(ridgecv).fit(
                            X_subtrain[:, ss_features_05], y_subtrain
                        )
                    ...
                    ss_features_08 = list(
                        stab_sel.get_support(indices=True, new_hard_threshold=0.8)
                    )
                    jaccard_ground_truth_ss_08.append(
                        jaccard_similarity(ss_features_08, groud_truth_features)
                    )
                    ...
                    if len(ss_features_08) == 0:
                        ...
                        ss_08_ridge = clone(ridgecv).fit(
                            X_subtrain[:, ss_features_08], y_subtrain
                        )
                    ...
                    true_FDRs_estimates, true_FDRs = compute_true_FDR(
                        stab_with_decoy, groud_truth_features
                    )
                    ...
                    jaccard_ground_truth_decoy.append(
                        jaccard_similarity(decoy_features, groud_truth_features)
                    )
                    ...
                    if len(decoy_features) == 0:
                        ...
                        decoy_ridge = clone(ridgecv).fit(
                            X_subtrain[:, decoy_features], y_subtrain
                        )
                    ...
                    jaccard_ground_truth_lasso.append(
                        jaccard_similarity(lasso_features, groud_truth_features)
                    )
                ...
                fdr_path = (
                    f"./{result_folder_title}/NbFeatures={n_features}_NbInfo={n_info}/FDR graphs/"
                ...
                scores_df = pd.DataFrame(
                    data={
                        "STABL_R2": decoy_r2_scores,
                        "STABL_MSE": decoy_mse_scores,
                        "STABL_MAE": decoy_mae_scores,
                        "SS_03_R2": ss_03_r2_scores,
                        "SS_03_MAE": ss_03_mae_scores,
                        "SS_03_MSE": ss_03_mse_scores,
                        "SS_05_R2": ss_05_r2_scores,
                        "SS_05_MAE": ss_05_mae_scores,
                        "SS_05_MSE": ss_05_mse_scores,
                        "SS_08_R2": ss_08_r2_scores,
                        "SS_08_MAE": ss_08_mae_scores,
                        "SS_08_MSE": ss_08_mse_scores,
                        "Lasso_R2": lasso_r2_scores,
                        "Lasso_MAE": lasso_mae_scores,
                ...
                scores_df.to_csv(
                    Path(scores_path, f"Raw_scores_NbSamples={n_samples}.csv")
                )

                # -----------------------------------------------------------------------------------
                # SAVING RAW PREDICTIONS
                folder = (
                    f"./{result_folder_title}/NbFeatures={n_features}_NbInfo={n_info}/Predictions/"
                    f"Raw_predictions_NbSamples={n_samples}"
                )

                dict_preds = {
                    "Lasso": all_lasso_preds,
                    "STABL": all_stabl_preds,
                    "SS_03": all_ss_03_preds,
                    "SS_05": all_ss_05_preds,
                ...
                df_features = pd.DataFrame(
                    data={
                        "# features STABL": [len(i) for i in all_stable_features_decoy],
                ...
                folder = (
                    f"./{result_folder_title}/NbFeatures={n_features}_NbInfo={n_info}/Jaccard/"
                    f"Raw_Jaccards_Performance"
                )
                os.makedirs(folder, exist_ok=True)

                df_jaccard_groud_truth = pd.DataFrame(
                    data={
                        "STABL": jaccard_ground_truth_decoy,
                ...
                df_jaccard_groud_truth.to_csv(
                    Path(folder, f"Jaccard_ground_truth_NbSamples={n_samples}.csv")
                )
                # -----------------------------------------------------------------------------------

                # SAVING RAW STABILITY JACCARDS
                folder = (
                    f"./{result_folder_title}/NbFeatures={n_features}_NbInfo={n_info}/"
                    f"Jaccard/Raw_Jaccards_Stability/"
                )
                os.makedirs(folder, exist_ok=True)
                df_jaccard_stability = pd.DataFrame()

                jaccard_value_decoy = jaccard_matrix(
                    all_stable_features_decoy, remove_diag=False
                )
                jaccard_value_decoy = np.array(
                    jaccard_value_decoy[np.triu_indices_from(jaccard_value_decoy, k=1)]
                ).flatten()

                jaccard_value_ss_03 = jaccard_matrix(
                    all_stable_features_ss_03, remove_diag=False
                )
                jaccard_value_ss_03 = np.array(
                    jaccard_value_ss_03[np.triu_indices_from(jaccard_value_ss_03, k=1)]
                ).flatten()

                jaccard_value_ss_05 = jaccard_matrix(
                    all_stable_features_ss_05, remove_diag=False
                )
                jaccard_value_ss_05 = np.array(
                    jaccard_value_ss_05[np.triu_indices_from(jaccard_value_ss_05, k=1)]
                ).flatten()

                jaccard_value_ss_08 = jaccard_matrix(
                    all_stable_features_ss_08, remove_diag=False
                )
                jaccard_value_ss_08 = np.array(
                    jaccard_value_ss_08[np.triu_indices_from(jaccard_value_ss_08, k=1)]
                ).flatten()

                jaccard_value_lasso = jaccard_matrix(
                    all_lasso_features, remove_diag=False
                )
                jaccard_value_lasso = np.array(
                    jaccard_value_lasso[np.triu_indices_from(jaccard_value_lasso, k=1)]
                ).flatten()
                ...
                df_jaccard_stability.to_csv(
                    Path(folder, f"Jaccard_stability_NbSamples={n_samples}.csv")
                )

                # Decoy Jaccard metrics for stability
                jaccard_matrix_decoy = jaccard_matrix(
                    all_stable_features_decoy,
                )
                ...
                df_results.loc[n_samples, "Decoy_Jaccard_Stab_Median"] = np.median(
                    jaccard_matrix_decoy
                )
                df_results.loc[n_samples, "Decoy_Jaccard_Stab_Q1"] = iqr_jaccard_decoy[
                    1
                ]
                df_results.loc[n_samples, "Decoy_Jaccard_Stab_Q3"] = iqr_jaccard_decoy[
                    0
                ]

                # Decoy Jaccard metrics for performance
                iqr_jaccard_ground_decoy = np.percentile(
                    jaccard_ground_truth_decoy, [75, 25]
                )
                df_results.loc[n_samples, "Decoy_Jaccard_Perf_Median"] = np.median(
                    jaccard_ground_truth_decoy
                )
                df_results.loc[n_samples, "Decoy_Jaccard_Perf_Q1"] = (
                    iqr_jaccard_ground_decoy[1]
                )
                df_results.loc[n_samples, "Decoy_Jaccard_Perf_Q3"] = (
                    iqr_jaccard_ground_decoy[0]
                )
                ...
                df_results.loc[n_samples, "Lasso_Jaccard_Stab_Median"] = np.median(
                    jaccard_matrix_lasso
                )
                df_results.loc[n_samples, "Lasso_Jaccard_Stab_Q1"] = iqr_jaccard_lasso[
                    1
                ]
                df_results.loc[n_samples, "Lasso_Jaccard_Stab_Q3"] = iqr_jaccard_lasso[
                    0
                ]

                # Lasso Jaccard metric for performance
                iqr_jaccard_ground_lasso = np.percentile(
                    jaccard_ground_truth_lasso, [75, 25]
                )
                df_results.loc[n_samples, "Lasso_Jaccard_Perf_Median"] = np.median(
                    jaccard_ground_truth_lasso
                )
                df_results.loc[n_samples, "Lasso_Jaccard_Perf_Q1"] = (
                    iqr_jaccard_ground_lasso[1]
                )
                df_results.loc[n_samples, "Lasso_Jaccard_Perf_Q3"] = (
                    iqr_jaccard_ground_lasso[0]
                )
                ...
                df_results.loc[n_samples, "SS_03_Jaccard_Stab_Median"] = np.median(
                    jaccard_matrix_ss_03
                )
                df_results.loc[n_samples, "SS_03_Jaccard_Stab_Q1"] = iqr_jaccard_ss_03[
                    1
                ]
                df_results.loc[n_samples, "SS_03_Jaccard_Stab_Q3"] = iqr_jaccard_ss_03[
                    0
                ]

                # SS03 Jaccard metric for performance
                iqr_jaccard_ground_ss_03 = np.percentile(
                    jaccard_ground_truth_ss_03, [75, 25]
                )
                df_results.loc[n_samples, "SS_03_Jaccard_Perf_Median"] = np.median(
                    jaccard_ground_truth_ss_03
                )
                df_results.loc[n_samples, "SS_03_Jaccard_Perf_Q1"] = (
                    iqr_jaccard_ground_ss_03[1]
                )
                df_results.loc[n_samples, "SS_03_Jaccard_Perf_Q3"] = (
                    iqr_jaccard_ground_ss_03[0]
                )
                ...
                df_results.loc[n_samples, "SS_05_Jaccard_Stab_Median"] = np.median(
                    jaccard_matrix_ss_05
                )
                df_results.loc[n_samples, "SS_05_Jaccard_Stab_Q1"] = iqr_jaccard_ss_05[
                    1
                ]
                df_results.loc[n_samples, "SS_05_Jaccard_Stab_Q3"] = iqr_jaccard_ss_05[
                    0
                ]

                # SS05 Jaccard metric for performance
                iqr_jaccard_ground_ss_05 = np.percentile(
                    jaccard_ground_truth_ss_05, [75, 25]
                )
                df_results.loc[n_samples, "SS_05_Jaccard_Perf_Median"] = np.median(
                    jaccard_ground_truth_ss_05
                )
                df_results.loc[n_samples, "SS_05_Jaccard_Perf_Q1"] = (
                    iqr_jaccard_ground_ss_05[1]
                )
                df_results.loc[n_samples, "SS_05_Jaccard_Perf_Q3"] = (
                    iqr_jaccard_ground_ss_05[0]
                )
                ...
                df_results.loc[n_samples, "SS_08_Jaccard_Stab_Median"] = np.median(
                    jaccard_matrix_ss_08
                )
                df_results.loc[n_samples, "SS_08_Jaccard_Stab_Q1"] = iqr_jaccard_ss_08[
                    1
                ]
                df_results.loc[n_samples, "SS_08_Jaccard_Stab_Q3"] = iqr_jaccard_ss_08[
                    0
                ]

                # SS08 Jaccard metric for performance
                iqr_jaccard_ground_ss_08 = np.percentile(
                    jaccard_ground_truth_ss_08, [75, 25]
                )
                df_results.loc[n_samples, "SS_08_Jaccard_Perf_Median"] = np.median(
                    jaccard_ground_truth_ss_08
                )
                df_results.loc[n_samples, "SS_08_Jaccard_Perf_Q1"] = (
                    iqr_jaccard_ground_ss_08[1]
                )
                df_results.loc[n_samples, "SS_08_Jaccard_Perf_Q3"] = (
                    iqr_jaccard_ground_ss_08[0]
                )

                # Lasso average nb features
                avg_selected_features_lasso = np.mean(
                    [len(i) for i in all_lasso_features]
                )
                df_results.loc[n_samples, "Avg_nb_features_Lasso"] = (
                    avg_selected_features_lasso
                )

                # Decoy average nb features
                avg_selected_features_decoy = np.mean(
                    [len(i) for i in all_stable_features_decoy]
                )
                df_results.loc[n_samples, "Avg_nb_features_Decoy"] = (
                    avg_selected_features_decoy
                )

                # SS03 average nb features
                avg_selected_features_ss_03 = np.mean(
                    [len(i) for i in all_stable_features_ss_03]
                )
                df_results.loc[n_samples, "Avg_nb_features_SS_03"] = (
                    avg_selected_features_ss_03
                )

                # SS05 average nb features
                avg_selected_features_ss_05 = np.mean(
                    [len(i) for i in all_stable_features_ss_05]
                )
                df_results.loc[n_samples, "Avg_nb_features_SS_05"] = (
                    avg_selected_features_ss_05
                )

                # SS08 average nb features
                avg_selected_features_ss_08 = np.mean(
                    [len(i) for i in all_stable_features_ss_08]
                )
                df_results.loc[n_samples, "Avg_nb_features_SS_08"] = (
                    avg_selected_features_ss_08
                )
            ...
            save_nb_features_plot(
                df_results, folder_name + "Avg features graphs/", nb_info=n_info
            )
